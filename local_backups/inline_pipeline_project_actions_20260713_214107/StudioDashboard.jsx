      ...
      <section className="fs-app">
        ...
        <div className="fs-body">
          <main className={`fs-workspace ${activeView === 'overview' ? 'fs-overview-workspace' : ''}`} tabIndex={0} aria-label="Central workspace content">
            ...
            {activeView !== 'overview' && !['team', 'issues', 'logs', 'settings'].includes(activeView) && <WorkspaceHint activeView={activeView} project={project} />}
  ...
  return (
    <section className="fs-hero">
      ...
      <div className="fs-hero-actions">
        ...
        <button type="button" className="fs-secondary" onClick={onNewProject}>Manual Project</button>
