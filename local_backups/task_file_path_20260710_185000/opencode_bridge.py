        ...
        try:
            ...
            while True:
                ...
                if session_id in self._cancelled_sessions:
                    _terminate_process_tree(proc)
                    return {"success": False, "error": "OpenCode task cancelled", "session_id": session_id, "cancelled": True, "timed_out": False, "subprocess_started": True, "exit_code": proc.returncode, "command_shape": command_shape}
            ...
            return {"success": False, "error": str(e), "session_id": session_id, "timed_out": False, "subprocess_started": False, "exit_code": None, "command_shape": command_shape}
        finally:
