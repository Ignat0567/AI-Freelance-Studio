...
from .workspace import atomic_write_json, sha256_file, validate_source_artifact
...
TRUSTED_FIXTURE_ARTIFACT_SHA256 = "179773764ae8843d27dbde78b9162a94fc9c924f30bb3e9d2f3a02a0722aa79f"
TRUSTED_FIXTURE_SOURCE_SHA256 = {
    "aifs_sandbox_fixture.nsi": "0b39f42db8601a2ae537bac96c3ddaabdbd67b62ba599c6ad343f0cb11959a03",
...
def build_fixture(*, compiler: Path | None = None, output: Path | None = None) -> FixtureBuildResult:
    ...
    for stale in (output_path, provenance_path):
        if stale.exists():
    ...
    return FixtureBuildResult(str(compiler_path), compiler_version, str(built), artifact_sha256, str(provenance_path))
